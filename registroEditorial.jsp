                            ...
                            <div class="col-xs-12">
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        ...
                                        <div>
                                            <form accion="EditorialControl" method="post" class="form-horizontal">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">                                                        
                                                        <input type="text" name="direccion" value="" placeholder="Codigo de la Categoria"/>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">                                                        
                                                        <input type="text" name="telefono" value="" placeholder="Codigo de la Categoria"/>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">                                                        
                                                        <input type="text" name="email" value="" placeholder="Codigo de la Categoria"/>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">                                                        
                                                        <input type="text" name="sitioweb" value="" placeholder="Codigo de la Categoria"/>
